...
$response['INVALID_AUTHENTICATION'] = array("code"=>'217', "message"=>'Invalid email and password');
$response['MOBILE_EXIST'] = array("code"=>'230', "message"=>'mobile already exists in database');
$response['MOBILE_DOESNOT_EXIST'] = array("code"=>'231', "message"=>'mobile  does not exists in database');
$response['MOBILE_PASSWORD_NOT_MATCH'] = array("code"=>'232', "message"=>'mobile  and password do not match');
?>